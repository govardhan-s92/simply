<?php /* Smarty version Smarty-3.1.19, created on 2017-05-19 15:21:14
         compiled from "/opt/lampp/htdocs/simplybasket.com/prestashop/themes/default-bootstrap/addresses.tpl" */ ?>
<?php /*%%SmartyHeaderCode:461997230591ef14ad53fd0-52390954%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f684ce2c102a34c4ea1ff5b98736dfdbec656d47' => 
    array (
      0 => '/opt/lampp/htdocs/simplybasket.com/prestashop/themes/default-bootstrap/addresses.tpl',
      1 => 1446110214,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '461997230591ef14ad53fd0-52390954',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_591ef14ae4c5b3_48386505',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_591ef14ae4c5b3_48386505')) {function content_591ef14ae4c5b3_48386505($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/opt/lampp/htdocs/simplybasket.com/prestashop/tools/smarty/plugins/modifier.replace.php';
?>
...
<?php $_tmp3=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('address',true,null,"id_address=".$_tmp3), ENT_QUOTES, 'UTF-8', true);?>
...
<i class="icon-chevron-right right"></i></span></a>
                <a class="btn btn-default button button-small" href="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['address']->value['object']['id']);?>
<?php $_tmp4=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('address',true,null,"id_address=".$_tmp4."&delete"), ENT_QUOTES, 'UTF-8', true);?>
