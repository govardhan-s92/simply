<?php /* Smarty version Smarty-3.1.19, created on 2017-05-27 12:14:28
         compiled from "/opt/lampp/htdocs/simplybasket.com/prestashop/themes/leo_monica/sub/product_info/tab.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19688761325929204c03e7c4-48383842%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7db2143fbd148f991a4f3b5c08d5af09f507f37b' => 
    array (
      0 => '/opt/lampp/htdocs/simplybasket.com/prestashop/themes/leo_monica/sub/product_info/tab.tpl',
      1 => 1447747634,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '19688761325929204c03e7c4-48383842',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5929204c3ecec8_86298589',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5929204c3ecec8_86298589')) {function content_5929204c3ecec8_86298589($_smarty_tpl) {?><?php if (!is_callable('smarty_function_cycle')) include '/opt/lampp/htdocs/simplybasket.com/prestashop/tools/smarty/plugins/function.cycle.php';
...
?>
								<?php if (($_smarty_tpl->tpl_vars['accessory']->value['allow_oosp']||$_smarty_tpl->tpl_vars['accessory']->value['quantity_all_versions']>0||$_smarty_tpl->tpl_vars['accessory']->value['quantity']>0)&&$_smarty_tpl->tpl_vars['accessory']->value['available_for_order']&&!isset($_smarty_tpl->tpl_vars['restricted_country_mode']->value)) {?>
									...
									<div class="product_block col-xs-12 col-sm-6 col-md-3 col-lg-3 item ajax_block_product<?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['accessories_list']['first']) {?> first_item<?php } elseif ($_smarty_tpl->getVariable('smarty')->value['foreach']['accessories_list']['last']) {?> last_item<?php } else { ?> item<?php }?> product_accessories_description">
...
" class="product_description">
													...
													<div class="clearfix functional-buttons" style="margin-top:14px">
														<?php if (!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value&&($_smarty_tpl->tpl_vars['accessory']->value['allow_oosp']||$_smarty_tpl->tpl_vars['accessory']->value['quantity']>0)) {?>
																<a style="width: 100%" class="exclusive button ajax_add_to_cart_button btn btn-outline" href="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['accessory']->value['id_product']);?>
