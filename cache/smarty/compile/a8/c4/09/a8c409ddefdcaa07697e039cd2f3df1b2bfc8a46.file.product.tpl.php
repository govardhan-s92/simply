<?php /* Smarty version Smarty-3.1.19, created on 2017-05-27 12:14:27
         compiled from "/opt/lampp/htdocs/simplybasket.com/prestashop/themes/leo_monica/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3426750065929204b720285-79258581%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a8c409ddefdcaa07697e039cd2f3df1b2bfc8a46' => 
    array (
      0 => '/opt/lampp/htdocs/simplybasket.com/prestashop/themes/leo_monica/product.tpl',
      1 => 1447747620,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3426750065929204b720285-79258581',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5929204c00b479_16572172',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5929204c00b479_16572172')) {function content_5929204c00b479_16572172($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/opt/lampp/htdocs/simplybasket.com/prestashop/tools/smarty/plugins/function.math.php';
if (!is_callable('smarty_modifier_date_format')) include '/opt/lampp/htdocs/simplybasket.com/prestashop/tools/smarty/plugins/modifier.date_format.php';
?>
...
" >
						...
						<a class="add_to_wishlist btn btn-default buttons_bottom_block" href="#" onclick="WishlistCart('wishlist_block_list', 'add', '<?php echo intval($_smarty_tpl->tpl_vars['product']->value->id);?>
', $('#idCombination').val(), document.getElementById('quantity_wanted').value); return false;" rel="nofollow"  title="<?php echo smartyTranslate(array('s'=>'Add to my wishlist'),$_smarty_tpl);?>
">
							<i class="fa fa-heart"></i><span><?php echo smartyTranslate(array('s'=>'Add to wishlist'),$_smarty_tpl);?>
</span>
						</a>
					</div> <!-- end box-cart -->
