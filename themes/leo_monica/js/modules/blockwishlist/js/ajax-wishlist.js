...
{	
	...
	var product_name = $.trim($('.addToWishlist[rel='+id_product+']').parents('.product-container').find('.product-name').html());
	//Leotheme add: if product added wishlist change action to delete
	if($('.addToWishlist[rel='+id_product+']').hasClass('checked'))
	{
		action = 'delete';
	}
	//Leotheme add: create content to popup when add wishlist
	var content_alert_delete = 'The product <strong>'+product_name+'</strong> was successfully removed from your wishlist. '+'<a href="'+mywishlist_url+'"><strong>View your wishlist.</strong></a>';
	var content_alert = 'The product <strong>'+product_name+'</strong> was successfully added to your wishlist.'+' <a href="'+mywishlist_url+'"><strong>View your wishlist.</strong></a>';
	$.ajax({
		type: 'GET',
...
function wishlistRefreshStatus()
{
	$('.addToWishlist').each(function(){
		if ($.inArray(parseInt($(this).prop('rel')),array_wishlist_product)!= -1) //leo theme edit
