		...
		<div class="heading media">
			<div class="cart-inner media-body">
				<a href="{$link->getPageLink($order_process, true)|escape:'html':'UTF-8'}" title="{l s='View my shopping cart' mod='blockcart'}" rel="nofollow">
					<div class="cart-inner media-body">
						<h4 class="title-cart"><span>{l s='my cart' mod='blockcart'}</span></h4> 
							...
							<div class="cart-quantity">
								...
								<span class="ajax_cart_product_empty ajax_cart_no_product{if $cart_qties > 0} unvisible{/if}">{l s='0' mod='blockcart'}<i class="hidden-all">{l s=' item' mod='blockcart'}</i></span>
								<span class="hidden-all ajax_cart_total{if $cart_qties == 0} unvisible{/if}">
									{if $cart_qties > 0}
										{if $priceDisplay == 1}
