                            ...
                            <tr>
                                ...
                                <td>
                                    <select type="text" class="layer_transition" name="layer_transition" id="layer_transition_{$language.id_lang|intval}"> 
                                        ...
                                        <option value="wipeTop">{l s='Wipe Top' mod='leoslideshow'}</option>
                                        <option value="wipeBottom">{l s='Wipe Bottom' mod='leoslideshow'}</option>
                                        ...
                                        <option value="expandTop">{l s='Expand Top' mod='leoslideshow'}</option>
                                        <option value="expandBottom">{l s='Expand Bottom' mod='leoslideshow'}</option>
                                    </select>
                                </td>
                            </tr>	
                        </table>
...
{literal}
    <script type="text/javascript"><!--
        var ajaxfilelink = "{/literal}{$ajaxfilelink}{* HTML form , no escape necessary *}{literal}";
        var title_image = "{/literal}{l s='Image Management' mod='leoslideshow'}{literal}";
        var psBaseModuleUri = "{/literal}{$psBaseModuleUri|escape:'html':'UTF-8'}{literal}";
        var txt_input_title = "{/literal}{l s='Please input title of slider for all language' mod='leoslideshow'}{literal}";
    ...
    <script type="text/javascript">
        $( document ).ready( function(){
            ...
            var SURLIMAGE = '{/literal}{$ajaxfilelink}{* HTML form , no escape necessary *}{literal}';
            var delay = '{/literal}{$delay|intval}{literal}';
            {/literal}
            {foreach from=$languages item=language}{literal}
                $leoEditor.countItem[{/literal}{$language.id_lang|intval}{literal}] = 0;
            {/literal}{/foreach}
            {literal}
